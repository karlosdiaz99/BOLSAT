...
<header>
  ...
  <div class="row">
			...
			<nav>
				<ul>
					<li class="submenu">
						<a href="#" ><span class="icon-user"></span>Empresa<span class="caret icon-circle-down"></span></a>
		...
		<div id="login" >
			...
			<form name="loginform" id="loginform" action="validadEmpresa.php" method="POST" class="cuerpo" >
			<p>
			 <label for="user_login">Nombre De Usuario<br />
			 <input type="text" name="razon_social" id="nombre_acceso" class="input" placeholder="&#128100; Id" value="" size="20" /></label>
			 </p>
			 <p>
			 ...
			 <input type="submit" name="login" class="button" value="Ingresar" />
			 			 ...
			 			 <a href="registroEmpresa.php">REGISTRARSE</a>
			</form>
