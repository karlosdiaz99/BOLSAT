...
<div class="menus">
			...
			<nav>
				<ul>
					<li class="submenu">
						<a href="#" ><span class="icon-user"></span>Datos de Empresa<span class="caret icon-circle-down"></span></a>
						<ul class="children">
							<li><a href="Empresa.php">Modiificar</a></li>
							<li><a href="Empresa.php">Visualizar</a></li>
						</ul>
					</li>
					<li class="submenu">
						<a href="#"><span class="icon-book2"></span>Solicitudes<span class="caret icon-circle-down"></span></a>
							<ul class="children">
								<li><a href="solicitud.php">Actualizar</a></li>								
								<li><a href="solicitud.php">Agregar</a></li>
								
								<li><a href="Empresa.php">Historial</a></li>
								
							</ul>
					</li>
			
					<li class="submenu">
						<a href="#"><span class="icon-book2"></span>Vinculacion<span class="caret icon-circle-down"></span></a>
							<ul class="children">
								<li><a href="Empresa.php">Documentacion</a></li>
								<li><a href="Empresa.php">Tramites</a></li>
								<li><a href="Empresa.php">Historial</a></li>
							</ul>
					</li>
					...
					<li class="submenu">
						<a href="#"><span class="icon-book2"></span>Contacto<span class="caret icon-circle-down"></span></a>
							<ul class="children">
								<li><a href="Empresa.php">Contacto Alumnos</a></li>
								<li><a href="Empresa.php">Contacto Departamento</a></li>
							</ul>
					</li>
